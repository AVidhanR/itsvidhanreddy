      ...
      <div className="">
        ...
        <div className="flex-col flex items-center m-6">
          <article className="w-[80%] mb-6">
            ...
            <div className="text-lg">
              <p className="list-item-custom list-item">
                ...
                skills and knowledge to the best of my abilities and contribute
                to the growth of the organization.
              </p>
              <p className="list-item-custom list-item">
                Seeking a challenging web development position where I can
                utilize my expertise in front-end and back-end technologies to
              ...
              <p className="list-item-custom list-item">
                ...
                high-quality, responsive websites that exceed client
                expectations.
              </p>
            </div>
          </article>
          <article className="w-[80%] mb-6">
            ...
            <div className="text-lg">
              <p className="list-item-custom list-item">
                Proficient in C, C++, Java, Python, and Kotlin. Basic knowledge
                in Firebase (Backend Service).
              </p>
              <p className="list-item-custom list-item">
                Skilled in HTML5, CSS3, SCSS, Tailwind CSS, and JavaScript.
                Familiar with web frameworks such as Bootstrap, Tailwind CSS,
                and ReactJs. Knowledgeable and basic practice in MySQL and
                PL/SQL.
              </p>
              <p className="list-item-custom list-item">
                Experienced in{" "}
              ...
              <p className="list-item-custom list-item">
                ...
                Studio, and Jetbrains Fleet. Beginner-level experience with
                Google Cloud.
              </p>
              <p className="list-item-custom list-item">
          ...
          <article className="w-[80%] mb-6">
            ...
            <div className="text-lg">
              ...
              <p className="list-item-custom list-item">
                Relevant Coursework: Data Structures using C, Design and
                Analysis of Algorithms, Database Management Systems, Artificial
          ...
          <article className="w-[80%] mb-6">
            ...
            <div className="text-lg">
              ...
              <p className="list-item-custom list-item">
                Achieved recognition as a Top 10 Participant at the
